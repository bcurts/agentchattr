...
const BRAND_AVATARS = {
    ...
    // the avatar circle (no shared CSS). The disc intentionally covers the
    // brand-color container: #e5e5e5 stays as the pill/mention/name accent.
    // Glyph scaled 0.84: its tips would otherwise poke past the disc edge.
